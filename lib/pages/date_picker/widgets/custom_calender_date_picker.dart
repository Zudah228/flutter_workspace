...
class CustomCalendarDatePicker extends CalendarDatePicker {
...
/// 以下、Flutter 3.0.4 のコピペ
/// 年数の表示
/// 年数の文字列が、外からいじれない内容（ MaterialLocalizations や、単に year.toString()）だったので、コピペする形をとっている。
/// 変更箇所は、[WARNING: flutter sdk の変更箇所] というコメントをつけている。
    ...
    return Stack(
      children: <Widget>[
        ...
        _DatePickerModeToggleButton(
          mode: _mode,
          // WARNING: flutter sdk の変更箇所
          // 元の実装
          // title: _localizations.formatMonthYear(_currentDisplayedMonthDate)
          title: _currentDisplayedMonthDate.format(
              useJapaneseEra: true, pattern: 'M'),
          onTitlePressed: () {
      ...
      child: Container(
        ...
        child: Center(
          child: Semantics(
            ...
            child: Text(
                DateTime(year).format(pattern: 'y', useJapaneseEra: true),
                style: itemStyle),
          ),
        ),
      ),
